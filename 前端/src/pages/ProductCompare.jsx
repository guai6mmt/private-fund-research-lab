    ...
    <React.Fragment>
      ...
      <div className="card" style={{ marginBottom: 14 }}>
        <div className="card-header">
          <div>
            <div className="card-title"><span className="bar" />对比清单 · {cmpProducts.length} 只</div>
            <div className="card-sub">最多支持 6 只产品同框对比</div>
          </div>
            ...
            <table className="tbl zebra">
              <thead>
                <tr>
                  ...
                  <th className="col-num">波动率</th>
                  <th className="col-num">夏普</th>
                  <th className="col-num">卡玛</th>
              ...
              <tbody>
                ...
                return (
                  <tr key={p.id}>
                      ...
                      <td className="col-num">{(p.annualReturn * 100).toFixed(2)}%</td>
                      <td className="col-num" style={{ color: "var(--red)" }}>{(p.maxDrawdown * 100).toFixed(2)}%</td>
                      <td className="col-num">{(p.vol * 100).toFixed(2)}%</td>
                      <td className="col-num">{p.sharpe.toFixed(2)}</td>
                      <td className="col-num">{p.calmar.toFixed(2)}</td>
